...
const addDoctor = async (req, res) => {
    ...
    try {
        ...
        // hacer hash al user password
        const salt = await bcrypt.genSalt(10); // a mas numero mas tiempo tomara 
...
//  API para obtener toda la lista de doc para admin panel
...
// API para obtener la info del dashboard del admin panel
