...
const MyProfile = () => {
    ...
    // Funcion actualizar info del perfil
    ...
    return userData ? (
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div>
                <p className='text-gray-600 underline mt-3'>INFORMACION DE CONTACTO</p>
            ...
            <div>
                <p className='text-[#797979] underline mt-3'>INFORMACION BASICA</p>
            ...
            <div className='mt-10'>
                ...
                {isEdit
                    ? <button onClick={updateUserProfileData} className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all'>Guardar informacion</button>
